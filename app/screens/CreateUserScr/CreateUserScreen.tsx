...
type AuthStackParamList = {
  CreateUserScreen: undefined; // Diğer ekranlarınız için ek parametreler tanımlayabilirsiniz
    LoginScreen: undefined;
    // Örneğin: Home: { userId: string };
  };
  
type Props = NativeStackScreenProps<AuthStackParamList, 'CreateUserScreen'>;
